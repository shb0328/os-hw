...
void Main( void )
{
    ...
    *( ( DWORD* ) vcVendorString + 2 ) = dwECX;
    ...
    kPrintString( 43, 8, vcVendorString );
...
BOOL kInitializeKernel64Area( void )
{
    ...
    // 초기화를 시작할 어드레스인 0x100000(1MB)를 설정
